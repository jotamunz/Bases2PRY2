...
exec sp_articleview @publication = N'ReplicationCR', @article = N'VENTAS', @view_name = N'SYNC_VENTAS_1__62', @filter_clause = N'EXISTS
(
	SELECT 1
	FROM [dbo].[CLIENTES]
	WHERE [dbo].[CLIENTES].Pais = N''CR'' AND [dbo].[VENTAS] .Cliente = [dbo].[CLIENTES].Codigo
